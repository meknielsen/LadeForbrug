...
type LayoutRouteId = RouteId | "/(authed)/ladeboks" | "/(authed)/ladeboks/[oid]"
type LayoutParams = RouteParams & { oid?: string }
...
type ActionsExport = typeof import('../../../../../../src/routes/(authed)/ladeboks/+page.server.js').actions
