...
function create_fragment2(ctx) {
  ...
  let mounted;
  let dispose;
  const innergrid_spread_levels = [prefixFilter(
    /*$$restProps*/
    ctx[6],
    "innerGrid$"
  )];
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      const innergrid_changes = dirty & /*prefixFilter, $$restProps*/
      64 ? get_spread_update(innergrid_spread_levels, [get_spread_object(prefixFilter(
        /*$$restProps*/
        ctx2[6],
        "innerGrid$"
      ))]) : {};
      ...
      set_attributes(div, div_data = get_spread_update(div_levels, [
        (!current || dirty & /*className, fixedColumnWidth, align*/
