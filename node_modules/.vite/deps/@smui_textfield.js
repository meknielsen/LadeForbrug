...
function create_else_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file3, 167, 2, 5537);
    },
    m: function mount(target, anchor) {
...
function create_if_block_10(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(span, file3, 61, 8, 2179);
    },
    m: function mount(target, anchor) {
...
function create_if_block_3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(span, file3, 103, 6, 3634);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, span, anchor);
